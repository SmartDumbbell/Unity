...
public class Login_PanelChange : MonoBehaviour
{
    ...
    public GameObject panel_SignUp1;
    public GameObject panel_SignUp2;
    public GameObject panel_SignUp3;
    public GameObject survey_Start;
    public GameObject survey_Panel;
    public GameObject survey_End;
    public RectTransform SI;
    public RectTransform SU_1;
    public RectTransform SU_2;
    public RectTransform SU_3;

    // 설문지 패널
    public GameObject survey_1;
    public GameObject survey_2;
    public GameObject survey_3;
    public GameObject survey_4;
    public GameObject survey_5;
    public GameObject survey_6;
    ...
    // ImageChanger
    public Image imageBar1;
    public Image imageBar2;
    public Image imageBar3;
    public Image imageBar4;
    public Image imageBar5;
    public Color fillIn;
    ...
    void Start()
    {
        ...
        panel_SignUp1.SetActive(false);
        panel_SignUp2.SetActive(false);
        panel_SignUp3.SetActive(false);
        survey_End.SetActive(false);
        survey_Start.SetActive(false);
        survey_Panel.SetActive(false);
    ...
    public void SignUp()
    {
        panel_SignUp1.SetActive(true);
        SI.DOAnchorPos(new Vector2(0, 0), 0.3f);
        SU_1.DOAnchorPos(new Vector2(30, 280), 0.3f);
    ...
    public void SignUp_Next_1()
    {
        ...
        panel_SignUp2.SetActive(true);
        SU_1.DOAnchorPos(new Vector2(0, 0), 0.3f);
        SU_2.DOAnchorPos(new Vector2(30, 280), 0.3f);
        SU_1.DOAnchorPos(new Vector2(-1000, 280), 0.3f);
        panel_SignUp1.SetActive(false);
    }
    ...
    public void SignUp_Next_2()
    {
        ...
        panel_SignUp3.SetActive(true);
        SU_2.DOAnchorPos(new Vector2(0, 0), 0.3f);
        SU_3.DOAnchorPos(new Vector2(30, 280), 0.3f);
        SU_2.DOAnchorPos(new Vector2(-1000, 280), 0.3f);
        panel_SignUp2.SetActive(false);
    }
    ...
    {
        panel_SignUp2.SetActive(true);
        SU_3.DOAnchorPos(new Vector2(1000, 280), 0.3f);
        SU_2.DOAnchorPos(new Vector2(30, 280), 0.3f);
        panel_SignUp3.SetActive(false);
    }
...
/*        image_1.gameObject.SetActive(true);*/
    ...
    {//00FF09
        ...
        imageBar1.color = fillIn;
        survey_2.SetActive(true);
        p1.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p2.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        survey_1.SetActive(false);
    }
    ...
    public void Survey2()
    {
        ...
        imageBar2.color = fillIn;
        survey_3.SetActive(true);
        p2.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p3.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        survey_2.SetActive(false);
    }
    ...
    public void Survey3()
    {
        ...
        imageBar3.color = fillIn;
        survey_4.SetActive(true);
        p3.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p4.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        survey_3.SetActive(false);
    }
    ...
    public void Survey4()
    {
        ...
        imageBar4.color = fillIn;
        survey_5.SetActive(true);
        p4.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p5.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        survey_4.SetActive(false);
    }
    ...
    public void Survey5()
    {
        ...
        imageBar5.color = fillIn;
        survey_6.SetActive(true);
        p5.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p6.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        survey_5.SetActive(false);
    }
    ...
    public void Survey6()
    {
        ...
        survey_6.SetActive(false);
    }

    // 설문 2 -> 1
    public void GoToQ1()
    {
        imageBar1.color = fillOut;
        survey_1.SetActive(true);
        p2.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p1.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        p2.DOAnchorPos(new Vector2(1239, -1376), 0.3f);
        survey_2.SetActive(false);
    }
    ...
    public void GoToQ2()
    {
        imageBar2.color = fillOut;
        survey_2.SetActive(true);
        p3.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p2.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        p3.DOAnchorPos(new Vector2(1239, -1376), 0.3f);
        survey_3.SetActive(false);
    }
    ...
    public void GoToQ3()
    {
        imageBar3.color = fillOut;
        survey_3.SetActive(true);
        p4.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p3.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        p4.DOAnchorPos(new Vector2(1239, -1376), 0.3f);
        survey_4.SetActive(false);
    }
    ...
    public void GoToQ4()
    {
        imageBar4.color = fillOut;
        survey_4.SetActive(true);
        p5.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p4.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        p5.DOAnchorPos(new Vector2(1239, -1376), 0.3f);
        survey_5.SetActive(false);
    }
    ...
    public void GoToQ5()
    {
        imageBar5.color = fillOut;
        survey_5.SetActive(true);
        p6.DOAnchorPos(new Vector2(-1476, -1376), 0.3f);  // 얘가 빠지고
        p5.DOAnchorPos(new Vector2(0, -1376), 0.3f);   // 얘가 들어감
        p6.DOAnchorPos(new Vector2(1239, -1376), 0.3f);   
        survey_6.SetActive(false);
    }
    ...
    {
        helper5.SetActive(true);
    }
    public void Helper_6()
    {
        helper6.SetActive(true);
    }

    // 도움말 나가기
    public void GoBack()
    {
        foreach (Button button in btn_Cancel)
        {
            helper1.SetActive(false);
            helper2.SetActive(false);
            helper3.SetActive(false);
            helper4.SetActive(false);
            helper5.SetActive(false);
            helper6.SetActive(false);
        }
    }
